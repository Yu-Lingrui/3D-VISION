...
sys.path.append(os.path.join('/home/ylr/下载/votenet/utils'))
sys.path.append(os.path.join('/home/ylr下载/votenet/models'))
sys.path.append(os.path.join('/media/ylr/文档2/sunrgbd'))
...
def object_recognize_3D(point):
    ...
    '''
    demo_dir = os.path.join('/home/ylr/下载/Test')
